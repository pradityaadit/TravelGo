    ...
    return (
      <div className="min-h-screen bg-gray-50 py-12 px-4 flex items-center justify-center">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Pemesanan Berhasil!</h2>
          ...
          <div className="bg-blue-50 border-2 border-blue-500 rounded-xl p-6 mb-8">
            ...
            <p className="text-4xl font-bold text-blue-600 tracking-wider">{bookingCode}</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="bg-white rounded-2xl shadow-lg p-8">
                <h2 className="text-2xl font-bold mb-6 text-gray-800">Data Penumpang</h2>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-24">
                <h3 className="text-xl font-bold mb-4 text-gray-800">Ringkasan Pesanan</h3>
                ...
                <div className="space-y-3 text-sm mb-6">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">{formatPrice(schedule.price)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Jumlah penumpang:</span>
